...
export default function NotePopup({ selectedDate, notes, setNotes }) {
          ...
          {!editing ? (
            <>
              ...
              <button
                ...
                className="mt-4 w-full py-2 text-sm bg-black text-white rounded-md hover:opacity-90 transition"
              >
